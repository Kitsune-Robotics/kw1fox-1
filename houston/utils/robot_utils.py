"""
This is the same source file from here: https://github.com/robotstreamer/robotstreamer/blob/master/robot_util.py

This should be a library or at the very least a submodule, come back to this sometime.
"""
...
def aplayFile(filename):
    for hardwareNumber in (2, 0, 1):
        _thread.start_new_thread(
            playSound, ("aplay -D plughw:%d,0 %s" % (hardwareNumber, filename),)
        )
